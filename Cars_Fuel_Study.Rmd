...
**Analysis on Fuel Consumption (MPG) on Citys **
...
When studying fuel consimption of cars, it is important to address the factor of engine size (i.e. displacement) and its correlation with fuel consumtion as per below: 
